"""
数据源抽象层：标的列表同步统一入口，支持 QMT、聚宽、tushare 等。
"""
from app.config import settings
from app.services.data_source.sync import sync_instruments, get_adapter_for_connection
...
__all__ = ["sync_instruments", "get_default_qmt_adapter", "get_adapter_for_connection"]
